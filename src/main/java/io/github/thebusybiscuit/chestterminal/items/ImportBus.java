...
public class ImportBus extends SlimefunItem {
        ...
        new BlockMenuPreset(getId(), "\u00a73CT Import Bus") {
            ...
            public void newInstance(@Nonnull BlockMenu menu, @Nonnull Block b) {
                if (!BlockStorage.hasBlockInfo(b) || BlockStorage.getLocationInfo(b.getLocation(), "filter-type") == null || BlockStorage.getLocationInfo(b.getLocation(), "filter-type").equals("whitelist")) {
                    menu.replaceExistingItem(23, CustomItemStack.create(XMaterial.WHITE_WOOL.parseMaterial(), "\u00a77Type: \u00a7fWhitelist", "", "\u00a7e> Click to change it to Blacklist"));
                    ...
                    menu.replaceExistingItem(23, CustomItemStack.create(XMaterial.BLACK_WOOL.parseMaterial(), "\u00a77Type: \u00a78Blacklist", "", "\u00a7e> Click to change it to Whitelist"));
                    menu.addMenuClickHandler(23, (p, slot, item, action) -> {
                ...
                if (!BlockStorage.hasBlockInfo(b) || BlockStorage.getLocationInfo(b.getLocation(), "filter-durability") == null || BlockStorage.getLocationInfo(b.getLocation(), "filter-durability").equals("false")) {
                    menu.replaceExistingItem(41, CustomItemStack.create(XMaterial.STONE_SWORD.parseMaterial(), "\u00a77Include Sub-IDs/Durability: \u00a74\u2718", "", "\u00a7e> Click to toggle whether the Durability has to match"));
                    ...
                    menu.replaceExistingItem(41, CustomItemStack.create(XMaterial.GOLDEN_SWORD.parseMaterial(), "\u00a77Include Sub-IDs/Durability: \u00a72\u2714", "", "\u00a7e> Click to toggle whether the Durability has to match"));
                    menu.addMenuClickHandler(41, (p, slot, item, action) -> {
                ...
                if (!BlockStorage.hasBlockInfo(b) || BlockStorage.getLocationInfo(b.getLocation(), "filter-lore") == null || BlockStorage.getLocationInfo(b.getLocation(), "filter-lore").equals("true")) {
                    menu.replaceExistingItem(32, CustomItemStack.create(XMaterial.MAP.parseMaterial(), "\u00a77Include Lore: \u00a72\u2714", "", "\u00a7e> Click to toggle whether the Lore has to match"));
                    ...
                    menu.replaceExistingItem(32, CustomItemStack.create(XMaterial.MAP.parseMaterial(), "\u00a77Include Lore: \u00a74\u2718", "", "\u00a7e> Click to toggle whether the Lore has to match"));
                    menu.addMenuClickHandler(32, (p, slot, item, action) -> {
    ...
    protected void constructMenu(@Nonnull BlockMenuPreset preset) {
        ...
        preset.addItem(7, CustomItemStack.create(XMaterial.ORANGE_STAINED_GLASS_PANE.parseMaterial(), " "), click);
        preset.addItem(8, CustomItemStack.create(XMaterial.ORANGE_STAINED_GLASS_PANE.parseMaterial(), " "), click);
        preset.addItem(16, CustomItemStack.create(XMaterial.ORANGE_STAINED_GLASS_PANE.parseMaterial(), " "), click);
        preset.addItem(25, CustomItemStack.create(XMaterial.ORANGE_STAINED_GLASS_PANE.parseMaterial(), " "), click);
        preset.addItem(26, CustomItemStack.create(XMaterial.ORANGE_STAINED_GLASS_PANE.parseMaterial(), " "), click);

        preset.addItem(2, CustomItemStack.create(XMaterial.PAPER.parseMaterial(), "\u00a73Items", "", "\u00a7bPut in all Items you want to", "\u00a7bblacklist/whitelist"), click);
    }
