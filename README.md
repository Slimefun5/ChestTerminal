...
[![bStats](https://bStats.org/signatures/bukkit/ChestTerminal.svg)](https://bStats.org/plugin/bukkit/ChestTerminal/31394)
...
ChestTerminal is heavily inspired by the famous mod [Applied Energistics](https://www.curseforge.com/minecraft/mc-mods/applied-energistics-2).
...
This project is open-source and licensed under the [MIT License](https://github.com/Slimefun5/ChestTerminal/blob/master/LICENSE).
...
dependencies {
    "githubCompileOnly"("Slimefun5:ChestTerminal:v1.1.2.7")
}
```

## Wiki

[Read more on the Slimefun Wiki...](https://github.com/Slimefun5/Wiki/wiki/ChestTerminal)
